...
#The seventh block
    ...
    def forward(
        ...
        attn_weights = nn.functional.softmax(attn_weights, dim=-1, dtype=torch.float32).to(query_states.dytpe)
        ...
        # Concate all the attention heads. [Batch_Size, Num_Patches, Embed_Dim]
